...
import { openExamFile, saveExamToFile } from '../fileSystemAccess'
...
describe('fileSystemAccess service', () => {
    ...
    describe('saveExamToFile', () => {
        it('should save exam to an existing fileHandle', async () => {
            ...
            const result = await saveExamToFile(examData, mockFileHandle);
        ...
        it('should prompt for a new fileHandle if none provided', async () => {
            ...
            const result = await saveExamToFile(examData);
        ...
        it('should return null if save fails', async () => {
            ...
            const result = await saveExamToFile({ title: 'Error Exam' });

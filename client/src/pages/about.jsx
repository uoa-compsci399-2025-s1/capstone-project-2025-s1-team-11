                    ...
                    <div style={{ marginTop: "2rem" }}>
                        ...
                        <ul style={{ paddingLeft: "1.5rem", fontSize: "1rem" }}>
                            <li style={{ marginBottom: "1rem" }}>   
                                <strong>Format Flexibility:</strong> Wide range of supported sources, including DOCX, LaTeX, and XML, allowing for compatibility with platforms such as Inspera, Moodle CodeRunner, Canvas, and more.
                            </li>
                            <li style={{ marginBottom: "1rem" }}>
                                <strong>Versioning Aptitude:</strong> Efficient shuffling of MCQs with a consistent answer key generation process.
                            </li>
                            <li style={{ marginBottom: "1rem" }}>
                                <strong>Clear Visual Feedback:</strong> Clean and straightforward previews, table views, and tabular modules for clarity.
                            </li>
                            <li style={{ marginBottom: "1rem" }}>
                                <strong>Marking Automation and Analysis:</strong> Fast processing of results with updatable marking rubrics. Built-in tools can generate insights into class performance and outcomes.
                            </li>
                            <li style={{ marginBottom: "1rem" }}>
                                <strong>Security:</strong> Local data hosting provides privacy and secure handling of files.
                            </li>
                        </ul>
                    </div>
                </div>
